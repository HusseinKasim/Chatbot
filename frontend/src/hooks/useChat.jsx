...
export default function useChat()
{
    ...
    async function handleLoggedInUserInput(prompt)
    {
        ...
        // Send prompt to backend via HTTP POST
        try{
            let response = await fetchWithAuth(`${import.meta.env.VITE_API_URL}/api/prompt/user`, {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
    ...
    async function updateChatSidebar(){
        ...
        try{
            let response = await fetchWithAuth(`${import.meta.env.VITE_API_URL}/api/chats/`, {
            method: 'GET',
            credentials: 'include'
            })
    ...
    async function updateUserChat(chatID){
        ...
        try{
            let response = await fetchWithAuth(`${import.meta.env.VITE_API_URL}/api/chats/${chatID}/messages`, {
            method: 'GET',
            credentials: 'include'
            })
    ...
    async function deleteUserChat(chatID){
        ...
        try{
            let response = await fetchWithAuth(`${import.meta.env.VITE_API_URL}/api/chats/${chatID}`, {
            method: 'DELETE',
            credentials: 'include'
            })
